...
//            return redirect()->route('dashboard');
    ...
    public function storeInfo(Request $request): RedirectResponse
    {
        $request->validate([
            ...
            'second_referral_name' => ['required', 'string', 'max:255', 'different:referral_name'],
            'second_referral_phone' => ['required', 'required_with:second_referral_name', 'string', 'digits:11', 'regex:/(09)[0-9]{9}/', 'different:referral_phone'],
