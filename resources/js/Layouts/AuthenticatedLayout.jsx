                            ...
                            {(breadcrumbs || headerExtra) && (
                                <>
                                    ...
                                    <div className={`container mx-auto py-6 px-4 sm:px-6 lg:px-8 flex ${(breadcrumbs && headerExtra) ? 'flex-col xl:flex-row space-y-5 xl:space-y-0' : ''} justify-between py-4 overflow-x-auto whitespace-nowrap`}>
                                        {breadcrumbs && (
                                            <div className="flex flex-col xl:flex-row xl:items-center gap-x-5 gap-y-2">
                                                <a href={route('dashboard')} className="flex gap-4 text-gray-600 dark:text-slate-200">
                                                ...
                                                {Object.keys(breadcrumbs).map((sectionName, i) => {
                                                    ...
                                                    return (
                                                        <div className="flex gap-5 mr-1 xl:mr-0 items-center" key={i}>
