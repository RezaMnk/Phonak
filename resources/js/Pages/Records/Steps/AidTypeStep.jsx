                 ...
                 <div className="flex mt-3">
                         ...
                         <div className="mt-5">
                             <div className="inline-block ml-8">
                                 ...
                                 <InputLabel
                                     ...
                                     className="border rounded-lg peer-checked:border-green-400"
                                 >
                                     <div className="p-2">
                     ...
                     <div className="w-3/4 flex flex-col">
                         <div className="w-full flex">
                             <div className="w-1/2 h-fit ml-5">
                                 <SelectInput
                                     id="type"
                                     name="name"
                                     value={data.type}
                         ...
                         <div className={`mt-5 transition-all ease-in-out duration-500 ${Object.keys(products).length ? 'max-h-full' : 'max-h-0'} overflow-hidden`}>
                             <ProductsSlider products={products} setProduct={setProduct} product={product} />
                         </div>
                     </div>
