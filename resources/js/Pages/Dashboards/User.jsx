...
export default function User({ patients, records, data }) {
                    ...
                    <div className="relative overflow-x-auto rounded-lg mt-12">
                        <table className="w-full text-right text-gray-500 dark:text-slate-400">
                            ...
                            {Object.values(patients).map((patient) => {
                                const is_last = patients[Object.keys(patients)[Object.keys(patients).length-1]] === patient;
                                return (
                                    <tr key={patient.id} className={`bg-white dark:bg-slate-800 ${! is_last ? 'border-b' : ''} border-gray-200 dark:border-slate-600`}>
                                        <th scope="row"
                                            className="px-6 py-4 text-sm font-medium text-gray-700 dark:text-slate-300 whitespace-nowrap">
            ...
            <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-3 mb-16">
                ...
                <div className="w-full bg-white dark:bg-slate-900 rounded-lg p-6">
                    <div className="flex flex-col space-y-4">
                        ...
                        <p className="text-sm text-gray-700 dark:text-slate-300">
                            تعداد کاربران جدید: {data.charts_data.patients} نفر
                            <span
                    ...
                    <div className="h-24 mt-8">
                        <ResponsiveContainer width="100%" height="100%">
                            <AreaChart
                                ...
                                data={data.charts}
                            >
                                <Area type="monotone" dataKey="patient_avg" stroke="#ca8a04" strokeWidth="1.5" fill="#ca8a0430" />
                            </AreaChart>
                        </ResponsiveContainer>
                    </div>
                </div>
