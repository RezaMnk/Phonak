    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-1 gap-8 xl:gap-16 xl:grid-cols-2 xl:grid-cols-3 mb-16">
                <Link href={route('users.index')} className="flex justify-between items-center bg-white dark:bg-slate-900 rounded-lg p-6 group">
                ...
                <Link href={route('admin.records')} className="flex justify-between items-center bg-white dark:bg-slate-900 rounded-lg p-6 group">
                    <div className="flex flex-col space-y-2 mr-5">
                ...
                <Link href={route('products.index')} className="flex justify-between items-center bg-white dark:bg-slate-900 rounded-lg p-6 group">
                    <div className="flex flex-col space-y-2 mr-5">
