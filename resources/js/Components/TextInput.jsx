        ...
        {svgIcon && (<label htmlFor={props.id} className="absolute">
            ...
            <>
                <input
                    ...
                    type={type}
                    className={`block w-full py-${size} text-gray-700 dark:text-gray-100 bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-500 rounded-lg ${svgIcon ? 'pr-11' : 'pr-5'} pl-5 focus:border-blue-900 dark:focus:border-blue-300 focus:ring-0 focus:outline-none disabled:bg-gray-100 dark:disabled:bg-slate-700 ` +
